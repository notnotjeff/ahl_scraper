  ...
  module Fetch
    class SeasonEndDate
      ...
      def call
        ...
        return Helpers::SeasonDates::DATE_EXCEPTIONS[@season_id][:end_date] if Helpers::SeasonDates::DATE_EXCEPTIONS.keys.include? @season_id
      ...
      def end_month
        Helpers::SeasonDates::SEASON_MONTH_KEY[@season_type.to_sym][:end_month]
      end
